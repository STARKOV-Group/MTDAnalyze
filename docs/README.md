...
**Solution.OfficialDocument** ->**Docflow.OfficialDocument** ->  
...
Иногда на проектах хочется внедрить автоматическое UI тестирование, а в случае больших длящихся проектов еще и возрастает ценность регрессионных тестов. В данный момент нет готового ответа на этот вопрос, но есть некоторые идеи, которые будут развиваться.  
...
Идеальным решением проблемы будет – написать максимально удобную обвязку для UI тестов, чтобы даже консультант после непродолжительного обучения смог чуть ли не мышкой натыкать необходимый сценарий проверки. Одним из элементов этого пути будет удобная табличка в Excel-е, в которой будет вся необходимая информация, только бери и пользуйся. Но тут следующая проблема – при активной разработке эта информация будет устаревать, поэтому надо снизить трудозатраты на обновление этого Excel файла.  
